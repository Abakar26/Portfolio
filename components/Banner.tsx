    ...
    <div className="flex flex-row items-center justify-center px-20 mt-[150px] z-[20] ">
      <div className="flex flex-col  justify-center  text-center">
        ...
        <p className="text-md text-gray-200 my-5 max-w-[600px]">
          Passionate Senior Software Engineer with a focus on MERN and ROR development,
          dedicated to crafting elegant and user-friendly mobile and Website applications.
        </p>
        <div className="text-md flex justify-center">
          <button
            onClick={() => window.open("mailto:bku52135@gmail.com")}
